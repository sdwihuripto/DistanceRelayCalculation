                                                        ...
                                                        Else
                                                            ...
                                                            Else
                                                                ...
                                                                Else
                                                                    ...
                                                                    Dim ZL10 As Double = Math.Sqrt(Math.Pow(RL10, 2) + Math.Pow(XL10, 2))
                                                                    Dim ZL20 As Double = Math.Sqrt(Math.Pow(RL20, 2) + Math.Pow(XL20, 2))
                                                                    Dim ZL30 As Double = Math.Sqrt(Math.Pow(RL30, 2) + Math.Pow(XL30, 2))
                                                                    Dim ZL40 As Double = Math.Sqrt(Math.Pow(RL40, 2) + Math.Pow(XL40, 2))
